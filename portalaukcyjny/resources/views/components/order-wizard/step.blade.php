...
<div style="width: {{ (1 / $numberOfSteps) * 100 }}%">
    <div class="relative mb-2">
        ...
        <div class="{{ $step->isPrevious() || $step->isCurrent() ? 'bg-green-500' : 'bg-white border-2 border-gray-200' }} mx-auto flex h-10 w-10 items-center rounded-full text-lg text-white">
        ...
        <div class="text-center text-xs md:text-base"> {{ $step->label }}</div>
    </div>